...
állapotváltozások eléréséhez), strukturált (forrásfájlok, blokkok, ciklusok, stb. $\rightarrow$ áttekinthetőség)   
    ...
    \begin{itemize}
      ...
      \item ``Szabványok'': C++ (1983), ``The C++ Programming Language'' (1985), \dots, \hiv{\href{https://www.iso.org/standard/79358.html}{ISO/IEC 14882:2020}}
...
\begin{frame}
  \begin{center}
    ...
    \hiv{\href{https://www.tiobe.com/tiobe-index/}{Tiobe}} programozási nyelv népszerűségi index, 2024. február
  \end{center}
\end{frame}
